    <!-- Mobile sidebar backdrop -->
        ...
        <!-- Sidebar -->
        <div id="sidebar" class="flex flex-col absolute z-50 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:w-64 2xl:!w-64 bg-white dark:bg-gray-800 shadow-lg shrink-0 border-r border-gray-200 dark:border-gray-700 transition-all duration-200 ease-in-out">
            <!-- Sidebar header -->
            <div class="flex justify-between items-center px-4 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-xl font-semibold text-gray-800 dark:text-gray-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Creta</span>
                </div>
                <button id="sidebarExpand" class="hidden lg:inline-flex items-center justify-center p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 ml-3">
            ...
            <div class="px-4 py-4">
                <!-- Dashboard group -->
                <div>
                    <h3 class="text-xs uppercase text-gray-500 dark:text-gray-400 font-semibold pl-3 mb-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Dashboard</h3>
                    <ul class="space-y-1">
                        <li>
                            <a href="#" class="flex items-center pl-3 py-2 rounded-lg bg-primary-50 dark:bg-gray-700 text-primary-600 dark:text-primary-400">
                                <div class="flex items-center justify-center w-6 h-6">
                                    <i class="fas fa-home text-sm"></i>
                                </div>
                                <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Overview</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Analytics</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Management group -->
                <div class="mt-6">
                    <h3 class="text-xs uppercase text-gray-500 dark:text-gray-400 font-semibold pl-3 mb-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Management</h3>
                    <ul class="space-y-1">
                        ...
                        <li x-data="{ open: false }" class="mb-1">
                            <button @click="open = !open" class="flex items-center justify-between w-full pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Users</span>
                                </div>
                                <div class="flex items-center justify-center w-6 h-6">
                        ...
                        <li x-data="{ open: false }" class="mb-1">
                            <button @click="open = !open" class="flex items-center justify-between w-full pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Products</span>
                                </div>
                                <div class="flex items-center justify-center w-6 h-6">
                                    <svg class="w-3 h-3 transform transition-transform duration-200" :class="{ 'rotate-90': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        ...
                        <li>
                            <a href="#" class="flex items-center pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Orders</span>
                ...
                <!-- Settings group -->
                <div class="mt-6">
                    <h3 class="text-xs uppercase text-gray-500 dark:text-gray-400 font-semibold pl-3 mb-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Settings</h3>
                    <ul class="space-y-1">
                        <li>
                            <a href="#" class="flex items-center pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex items-center justify-center w-6 h-6">
                                ...
                                <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">General</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center pl-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="ml-3 text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Security</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <!-- Sidebar footer -->
            <div class="pt-4 pb-4 px-4 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <button class="flex items-center text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
                        <div class="flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700">
                            <i class="fas fa-question text-sm"></i>
                        </div>
                        <span class="ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Help</span>
                    </button>
                    <button id="theme-toggle" class="flex items-center text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
                        ...
                        <span class="ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Theme</span>
                    </button>
                </div>
            </div>
        </div>